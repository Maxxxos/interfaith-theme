jQuery(document).ready(function($) {
	...
	if ($('#loginform').length){
		...
		$('.login-action-register .ml-extra-div').append('<div class="welcome-wrapper"><a href="/"><img src="/wp-content/uploads/2022/04/OneSpirit_Interfaith_Foundation_logo.png"></a><span class="login-welcome">You Are Welcome!</span></div>');
